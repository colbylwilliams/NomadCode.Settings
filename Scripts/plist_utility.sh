...
CheckEvenReleaseOddDevCompliance ()
{
	echo "Checking Version Number Compliance for $versionNumber"

	version=( ${versionNumber//./ } )	# replace points, split into array

	build=${version[2]}					# get the build component of the version
	...
	if [ "$release" = true ]; then
		if [ $((build%2)) -ne 0 ]; then
			...
			echo "*******************************************************************************************************"
			echo "**"
			echo "** Version Number Compliance Error:"
			echo "**"
			echo "** The Version Number $versionNumber build component (or last digit) $build must be an EVEN number for Release builds" 1>&2
			echo "**"
			echo "**"
			echo "*******************************************************************************************************"
			echo "*******************************************************************************************************"
	...
	elif [ $((build%2)) -eq 0 ]; then
		echo "*******************************************************************************************************"
		echo "*******************************************************************************************************"
		echo "**"
		echo "** Version Number Compliance Error:"
		echo "**"
		echo "** The Version Number $versionNumber build component (or last digit) $build must be an ODD number for Debug builds" 1>&2
		echo "**"
		echo "**"
		echo "*******************************************************************************************************"
		echo "*******************************************************************************************************"
